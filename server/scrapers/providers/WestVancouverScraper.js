      ...
      activityElements.forEach((element, index) => {
        try {
          ...
          const activity = {
            ...
            name: extractWestVanActivityName(element, text),
            cost: extractWestVanCost(text),
            schedule: extractWestVanSchedule(text),
            location: extractWestVanLocation(text),
            registrationUrl: extractWestVanRegistrationUrl(element),

            // West Vancouver specific fields
            ageRange: extractWestVanAgeRange(text),
            dates: extractWestVanDates(text),
            availability: extractWestVanAvailability(text, element),
            instructor: extractWestVanInstructor(text),
            description: extractWestVanDescription(element, text)
          };
