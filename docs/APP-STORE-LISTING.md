# App Store Listing - Kids Activity Tracker

This document contains all the text content needed for the App Store submission.
...
| **Bundle ID** | com.kidsactivitytracker.app |
| **Version** | 1.2.1 |
| **Build** | 2 |
...
```
kids activities,children,camps,swimming lessons,sports,classes,family,parenting,schedule,calendar
```

**Alternative keyword sets to test:**

Set A (activity focused):
```
kids activities,children programs,summer camps,swimming,sports,dance,art classes,recreation,youth
```

Set B (parent focused):
```
...
### Demo Account
Provide Apple reviewer with test credentials:
...
|------------|------|-------|-------------|
| premium_monthly | Auto-Renewable | $4.99/month | Premium Monthly - Unlimited profiles, calendar export, instant alerts |
| premium_annual | Auto-Renewable | $39.99/year | Premium Annual - Best value! Save 33% with annual subscription |

### Subscription Description (displayed to users)
