...
const capabilities: AICapability[] = [
  ...
  },
  {
    ...
    subtitle: 'Understand how activities benefit your child',
    description: 'Our AI explains exactly why each activity is great for your child\'s development. See how activities build confidence, coordination, social skills, and more - not just that they match your search.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    example: '💚 "Builds confidence and teamwork skills"',
  },
  {
    id: 'waitlist-alerts',
