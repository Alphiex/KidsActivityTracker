  ...
  return (
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-pink-100 rounded-full opacity-30 blur-3xl -translate-y-1/2 translate-x-1/2" />
